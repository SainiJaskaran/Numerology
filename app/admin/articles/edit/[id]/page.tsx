  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-background py-12">
        <div className="max-w-4xl mx-auto px-4 text-center text-muted-foreground">Loading article...</div>
      </div>
    )
  }
      ...
      <div className="min-h-screen bg-background py-12">
        <div className="max-w-4xl mx-auto px-4">
          <Card className="p-8 text-center">
            <p className="text-red-600 mb-6">Article not found</p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {success && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 flex gap-3">
            ...
            <p className="text-green-700">Article updated successfully! Redirecting...</p>
          </div>
        )}
        ...
        <Card className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Input placeholder="slug" value={formData.slug} readOnly disabled />
            </div>
